...
export default () => {
    ...
    return <>
       ...
       <View style={{ width: "96%", paddingLeft: '4%', paddingTop: '4%' }}>
           ...
           <FontAwesome name="plus-circle" size={20} color="#416c6e" style={{marginRight:10}} />
           <Text style={{color:'#416c6e',fontFamily:'PB',fontSize:20}}>Add Pet</Text>
            </View>
            ...
            <Text style={{color:'#416c6e',fontFamily:'PM',fontSize:16,marginBottom:-10}}>Category:</Text>
                ...
                <TextInput
                    ...
                    mode="flat"
                />
                                <Text style={{color:'#416c6e',fontFamily:'PM',fontSize:16,marginTop:10}}>Images:</Text>

                <ScrollView horizontal={true} style={{marginTop:10,marginBottom:10}}>
                <TouchableOpacity style={{width:80,height:80,borderWidth:2,borderColor:'#416c6e',marginRight:10,borderRadius:5,justifyContent:'center',alignItems:'center'}}>
                <Ionicons name="md-image-sharp" size={60} color="#416c6e" />
                </TouchableOpacity>
                <TouchableOpacity style={{width:80,height:80,borderWidth:2,borderColor:'#416c6e',marginRight:10,borderRadius:5,justifyContent:'center',alignItems:'center'}}>
                <Ionicons name="md-image-sharp" size={60} color="#416c6e" />
                </TouchableOpacity>
